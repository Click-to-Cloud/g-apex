...
var vlREj = function (_Component) {
  _inherits(vlREj, _Component);

  function vlREj() {
    _classCallCheck(this, vlREj);

    return _possibleConstructorReturn(this, (vlREj.__proto__ || Object.getPrototypeOf(vlREj)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vlREj, _step_6Soy2.default);

exports.default = vlREj;
...
exports.templates = exports.vlREj = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vlREj.
   * @public
   */

  goog.module('vlREj.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vlREj.render';
  }
...
_metalSoy2.default.register(vlREj, templates);
exports.vlREj = vlREj;
