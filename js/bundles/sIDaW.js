...
var sIDaW = function (_Component) {
  _inherits(sIDaW, _Component);

  function sIDaW() {
    _classCallCheck(this, sIDaW);

    return _possibleConstructorReturn(this, (sIDaW.__proto__ || Object.getPrototypeOf(sIDaW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sIDaW, _step_3Soy2.default);

exports.default = sIDaW;
...
exports.templates = exports.sIDaW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sIDaW.
   * @public
   */

  goog.module('sIDaW.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param747 = function param747() {
      ...
      ie_close('p');
      ie_open('p');
      itext('To use this component after installing G.apex, simply create a Lightning tab and select c:G_apex_demo in the dropdown list. Then visit the link in your org:');
      ie_close('p');
      ie_open('p');
      itext('https://YOUR_ORG/lightning/n/G_apex_demo');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sIDaW.render';
  }
...
_metalSoy2.default.register(sIDaW, templates);
exports.sIDaW = sIDaW;
