...
var _step_6Soy = __webpack_require__(321);
...
var soTHV = function (_Component) {
  _inherits(soTHV, _Component);

  function soTHV() {
    _classCallCheck(this, soTHV);

    return _possibleConstructorReturn(this, (soTHV.__proto__ || Object.getPrototypeOf(soTHV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(soTHV, _step_6Soy2.default);

exports.default = soTHV;
...
exports.templates = exports.soTHV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace soTHV.
   * @public
   */

  goog.module('soTHV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'soTHV.render';
  }
...
_metalSoy2.default.register(soTHV, templates);
exports.soTHV = soTHV;
