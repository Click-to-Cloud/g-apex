...
var MURUY = function (_Component) {
  _inherits(MURUY, _Component);

  function MURUY() {
    _classCallCheck(this, MURUY);

    return _possibleConstructorReturn(this, (MURUY.__proto__ || Object.getPrototypeOf(MURUY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MURUY, _directiveSoy2.default);

exports.default = MURUY;
...
exports.templates = exports.MURUY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MURUY.
   * @public
   */

  goog.module('MURUY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MURUY.render';
  }
...
_metalSoy2.default.register(MURUY, templates);
exports.MURUY = MURUY;
