...
var WUzwl = function (_Component) {
  _inherits(WUzwl, _Component);

  function WUzwl() {
    _classCallCheck(this, WUzwl);

    return _possibleConstructorReturn(this, (WUzwl.__proto__ || Object.getPrototypeOf(WUzwl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(WUzwl, _step_1Soy2.default);

exports.default = WUzwl;
...
exports.templates = exports.WUzwl = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace WUzwl.
   * @public
   */

  goog.module('WUzwl.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'WUzwl.render';
  }
...
_metalSoy2.default.register(WUzwl, templates);
exports.WUzwl = WUzwl;
