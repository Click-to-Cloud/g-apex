...
var YogWF = function (_Component) {
  _inherits(YogWF, _Component);

  function YogWF() {
    _classCallCheck(this, YogWF);

    return _possibleConstructorReturn(this, (YogWF.__proto__ || Object.getPrototypeOf(YogWF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YogWF, _step_12Soy2.default);

exports.default = YogWF;
...
exports.templates = exports.YogWF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YogWF.
   * @public
   */

  goog.module('YogWF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YogWF.render';
  }
...
_metalSoy2.default.register(YogWF, templates);
exports.YogWF = YogWF;
