...
var ZWRYE = function (_Component) {
  _inherits(ZWRYE, _Component);

  function ZWRYE() {
    _classCallCheck(this, ZWRYE);

    return _possibleConstructorReturn(this, (ZWRYE.__proto__ || Object.getPrototypeOf(ZWRYE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ZWRYE, _step_9Soy2.default);

exports.default = ZWRYE;
...
exports.templates = exports.ZWRYE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ZWRYE.
   * @public
   */

  goog.module('ZWRYE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ZWRYE.render';
  }
...
_metalSoy2.default.register(ZWRYE, templates);
exports.ZWRYE = ZWRYE;
