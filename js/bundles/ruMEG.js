...
var ruMEG = function (_Component) {
  _inherits(ruMEG, _Component);

  function ruMEG() {
    _classCallCheck(this, ruMEG);

    return _possibleConstructorReturn(this, (ruMEG.__proto__ || Object.getPrototypeOf(ruMEG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ruMEG, _step_5Soy2.default);

exports.default = ruMEG;
...
exports.templates = exports.ruMEG = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ruMEG.
   * @public
   */

  goog.module('ruMEG.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ruMEG.render';
  }
...
_metalSoy2.default.register(ruMEG, templates);
exports.ruMEG = ruMEG;
