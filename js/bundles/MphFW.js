...
var _data_typeSoy = __webpack_require__(285);
...
var MphFW = function (_Component) {
  _inherits(MphFW, _Component);

  function MphFW() {
    _classCallCheck(this, MphFW);

    return _possibleConstructorReturn(this, (MphFW.__proto__ || Object.getPrototypeOf(MphFW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MphFW, _data_typeSoy2.default);

exports.default = MphFW;
...
exports.templates = exports.MphFW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MphFW.
   * @public
   */

  goog.module('MphFW.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param503 = function param503() {
      ...
      ie_close('td');
      ie_open('td');
      itext('new G.MapType(G.DataType)');
      ie_close('td');
      ie_close('tr');
      ie_open('tr');
      ie_open('td');
      ...
      ie_open('h2');
      itext('Map Type Methods');
      ie_close('h2');
      ie_open('p');
      itext('Map type receives the element type as the type of the value and its key type is always String.');
      ie_close('p');
      ie_open('table');
      ie_open('thead');
      ie_open('tr');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MphFW.render';
  }
...
_metalSoy2.default.register(MphFW, templates);
exports.MphFW = MphFW;
