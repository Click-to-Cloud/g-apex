...
var PWpGm = function (_Component) {
  _inherits(PWpGm, _Component);

  function PWpGm() {
    _classCallCheck(this, PWpGm);

    return _possibleConstructorReturn(this, (PWpGm.__proto__ || Object.getPrototypeOf(PWpGm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(PWpGm, _step_7Soy2.default);

exports.default = PWpGm;
...
exports.templates = exports.PWpGm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace PWpGm.
   * @public
   */

  goog.module('PWpGm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'PWpGm.render';
  }
...
_metalSoy2.default.register(PWpGm, templates);
exports.PWpGm = PWpGm;
