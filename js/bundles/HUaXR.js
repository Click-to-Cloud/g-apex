...
var HUaXR = function (_Component) {
  _inherits(HUaXR, _Component);

  function HUaXR() {
    _classCallCheck(this, HUaXR);

    return _possibleConstructorReturn(this, (HUaXR.__proto__ || Object.getPrototypeOf(HUaXR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(HUaXR, _indexSoy2.default);

exports.default = HUaXR;
...
exports.templates = exports.HUaXR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace HUaXR.
   * @public
   */

  goog.module('HUaXR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'HUaXR.render';
  }
...
_metalSoy2.default.register(HUaXR, templates);
exports.HUaXR = HUaXR;
