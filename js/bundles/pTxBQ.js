...
var pTxBQ = function (_Component) {
  _inherits(pTxBQ, _Component);

  function pTxBQ() {
    _classCallCheck(this, pTxBQ);

    return _possibleConstructorReturn(this, (pTxBQ.__proto__ || Object.getPrototypeOf(pTxBQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(pTxBQ, _globalSoy2.default);

exports.default = pTxBQ;
...
exports.templates = exports.pTxBQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace pTxBQ.
   * @public
   */

  goog.module('pTxBQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'pTxBQ.render';
  }
...
_metalSoy2.default.register(pTxBQ, templates);
exports.pTxBQ = pTxBQ;
