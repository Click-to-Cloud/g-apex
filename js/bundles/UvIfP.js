...
var UvIfP = function (_Component) {
  _inherits(UvIfP, _Component);

  function UvIfP() {
    _classCallCheck(this, UvIfP);

    return _possibleConstructorReturn(this, (UvIfP.__proto__ || Object.getPrototypeOf(UvIfP)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UvIfP, _schemaSoy2.default);

exports.default = UvIfP;
...
exports.templates = exports.UvIfP = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace UvIfP.
   * @public
   */

  goog.module('UvIfP.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'UvIfP.render';
  }
...
_metalSoy2.default.register(UvIfP, templates);
exports.UvIfP = UvIfP;
