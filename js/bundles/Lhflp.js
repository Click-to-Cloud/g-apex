...
var Lhflp = function (_Component) {
  _inherits(Lhflp, _Component);

  function Lhflp() {
    _classCallCheck(this, Lhflp);

    return _possibleConstructorReturn(this, (Lhflp.__proto__ || Object.getPrototypeOf(Lhflp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Lhflp, _resolverSoy2.default);

exports.default = Lhflp;
...
exports.templates = exports.Lhflp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Lhflp.
   * @public
   */

  goog.module('Lhflp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Lhflp.render';
  }
...
_metalSoy2.default.register(Lhflp, templates);
exports.Lhflp = Lhflp;
