...
var mtilJ = function (_Component) {
  _inherits(mtilJ, _Component);

  function mtilJ() {
    _classCallCheck(this, mtilJ);

    return _possibleConstructorReturn(this, (mtilJ.__proto__ || Object.getPrototypeOf(mtilJ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mtilJ, _globalSoy2.default);

exports.default = mtilJ;
...
exports.templates = exports.mtilJ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mtilJ.
   * @public
   */

  goog.module('mtilJ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mtilJ.render';
  }
...
_metalSoy2.default.register(mtilJ, templates);
exports.mtilJ = mtilJ;
