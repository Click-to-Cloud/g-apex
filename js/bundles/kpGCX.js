...
var kpGCX = function (_Component) {
  _inherits(kpGCX, _Component);

  function kpGCX() {
    _classCallCheck(this, kpGCX);

    return _possibleConstructorReturn(this, (kpGCX.__proto__ || Object.getPrototypeOf(kpGCX)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kpGCX, _step_4Soy2.default);

exports.default = kpGCX;
...
exports.templates = exports.kpGCX = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kpGCX.
   * @public
   */

  goog.module('kpGCX.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kpGCX.render';
  }
...
_metalSoy2.default.register(kpGCX, templates);
exports.kpGCX = kpGCX;
