...
var gBVlT = function (_Component) {
  _inherits(gBVlT, _Component);

  function gBVlT() {
    _classCallCheck(this, gBVlT);

    return _possibleConstructorReturn(this, (gBVlT.__proto__ || Object.getPrototypeOf(gBVlT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(gBVlT, _directiveSoy2.default);

exports.default = gBVlT;
...
exports.templates = exports.gBVlT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace gBVlT.
   * @public
   */

  goog.module('gBVlT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'gBVlT.render';
  }
...
_metalSoy2.default.register(gBVlT, templates);
exports.gBVlT = gBVlT;
