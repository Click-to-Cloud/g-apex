...
var VCHMc = function (_Component) {
  _inherits(VCHMc, _Component);

  function VCHMc() {
    _classCallCheck(this, VCHMc);

    return _possibleConstructorReturn(this, (VCHMc.__proto__ || Object.getPrototypeOf(VCHMc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(VCHMc, _step_6Soy2.default);

exports.default = VCHMc;
...
exports.templates = exports.VCHMc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace VCHMc.
   * @public
   */

  goog.module('VCHMc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'VCHMc.render';
  }
...
_metalSoy2.default.register(VCHMc, templates);
exports.VCHMc = VCHMc;
