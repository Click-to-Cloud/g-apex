...
var BrWAK = function (_Component) {
  _inherits(BrWAK, _Component);

  function BrWAK() {
    _classCallCheck(this, BrWAK);

    return _possibleConstructorReturn(this, (BrWAK.__proto__ || Object.getPrototypeOf(BrWAK)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BrWAK, _step_14Soy2.default);

exports.default = BrWAK;
...
exports.templates = exports.BrWAK = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace BrWAK.
   * @public
   */

  goog.module('BrWAK.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'BrWAK.render';
  }
...
_metalSoy2.default.register(BrWAK, templates);
exports.BrWAK = BrWAK;
