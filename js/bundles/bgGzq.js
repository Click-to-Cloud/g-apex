...
var bgGzq = function (_Component) {
  _inherits(bgGzq, _Component);

  function bgGzq() {
    _classCallCheck(this, bgGzq);

    return _possibleConstructorReturn(this, (bgGzq.__proto__ || Object.getPrototypeOf(bgGzq)).apply(this, arguments));
  }
...
_metalSoy2.default.register(bgGzq, _indexSoy2.default);

exports.default = bgGzq;
...
exports.templates = exports.bgGzq = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace bgGzq.
   * @public
   */

  goog.module('bgGzq.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'bgGzq.render';
  }
...
_metalSoy2.default.register(bgGzq, templates);
exports.bgGzq = bgGzq;
