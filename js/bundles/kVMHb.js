...
var kVMHb = function (_Component) {
  _inherits(kVMHb, _Component);

  function kVMHb() {
    _classCallCheck(this, kVMHb);

    return _possibleConstructorReturn(this, (kVMHb.__proto__ || Object.getPrototypeOf(kVMHb)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kVMHb, _step_9Soy2.default);

exports.default = kVMHb;
...
exports.templates = exports.kVMHb = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kVMHb.
   * @public
   */

  goog.module('kVMHb.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kVMHb.render';
  }
...
_metalSoy2.default.register(kVMHb, templates);
exports.kVMHb = kVMHb;
