...
var uxRbw = function (_Component) {
  _inherits(uxRbw, _Component);

  function uxRbw() {
    _classCallCheck(this, uxRbw);

    return _possibleConstructorReturn(this, (uxRbw.__proto__ || Object.getPrototypeOf(uxRbw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uxRbw, _step_12Soy2.default);

exports.default = uxRbw;
...
exports.templates = exports.uxRbw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace uxRbw.
   * @public
   */

  goog.module('uxRbw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'uxRbw.render';
  }
...
_metalSoy2.default.register(uxRbw, templates);
exports.uxRbw = uxRbw;
