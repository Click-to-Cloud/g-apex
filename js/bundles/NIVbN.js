...
var NIVbN = function (_Component) {
  _inherits(NIVbN, _Component);

  function NIVbN() {
    _classCallCheck(this, NIVbN);

    return _possibleConstructorReturn(this, (NIVbN.__proto__ || Object.getPrototypeOf(NIVbN)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NIVbN, _step_14Soy2.default);

exports.default = NIVbN;
...
exports.templates = exports.NIVbN = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NIVbN.
   * @public
   */

  goog.module('NIVbN.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NIVbN.render';
  }
...
_metalSoy2.default.register(NIVbN, templates);
exports.NIVbN = NIVbN;
