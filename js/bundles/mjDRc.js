...
var mjDRc = function (_Component) {
  _inherits(mjDRc, _Component);

  function mjDRc() {
    _classCallCheck(this, mjDRc);

    return _possibleConstructorReturn(this, (mjDRc.__proto__ || Object.getPrototypeOf(mjDRc)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mjDRc, _indexSoy2.default);

exports.default = mjDRc;
...
exports.templates = exports.mjDRc = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mjDRc.
   * @public
   */

  goog.module('mjDRc.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mjDRc.render';
  }
...
_metalSoy2.default.register(mjDRc, templates);
exports.mjDRc = mjDRc;
