...
var QuhnT = function (_Component) {
  _inherits(QuhnT, _Component);

  function QuhnT() {
    _classCallCheck(this, QuhnT);

    return _possibleConstructorReturn(this, (QuhnT.__proto__ || Object.getPrototypeOf(QuhnT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(QuhnT, _step_1Soy2.default);

exports.default = QuhnT;
...
exports.templates = exports.QuhnT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace QuhnT.
   * @public
   */

  goog.module('QuhnT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'QuhnT.render';
  }
...
_metalSoy2.default.register(QuhnT, templates);
exports.QuhnT = QuhnT;
