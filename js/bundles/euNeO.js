...
var euNeO = function (_Component) {
  _inherits(euNeO, _Component);

  function euNeO() {
    _classCallCheck(this, euNeO);

    return _possibleConstructorReturn(this, (euNeO.__proto__ || Object.getPrototypeOf(euNeO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(euNeO, _indexSoy2.default);

exports.default = euNeO;
...
exports.templates = exports.euNeO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace euNeO.
   * @public
   */

  goog.module('euNeO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'euNeO.render';
  }
...
_metalSoy2.default.register(euNeO, templates);
exports.euNeO = euNeO;
