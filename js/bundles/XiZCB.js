...
var XiZCB = function (_Component) {
  _inherits(XiZCB, _Component);

  function XiZCB() {
    _classCallCheck(this, XiZCB);

    return _possibleConstructorReturn(this, (XiZCB.__proto__ || Object.getPrototypeOf(XiZCB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XiZCB, _step_3Soy2.default);

exports.default = XiZCB;
...
exports.templates = exports.XiZCB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XiZCB.
   * @public
   */

  goog.module('XiZCB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XiZCB.render';
  }
...
_metalSoy2.default.register(XiZCB, templates);
exports.XiZCB = XiZCB;
