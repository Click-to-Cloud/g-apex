...
var ytvkB = function (_Component) {
  _inherits(ytvkB, _Component);

  function ytvkB() {
    _classCallCheck(this, ytvkB);

    return _possibleConstructorReturn(this, (ytvkB.__proto__ || Object.getPrototypeOf(ytvkB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ytvkB, _step_7Soy2.default);

exports.default = ytvkB;
...
exports.templates = exports.ytvkB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ytvkB.
   * @public
   */

  goog.module('ytvkB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ytvkB.render';
  }
...
_metalSoy2.default.register(ytvkB, templates);
exports.ytvkB = ytvkB;
