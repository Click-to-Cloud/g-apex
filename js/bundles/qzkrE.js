...
var qzkrE = function (_Component) {
  _inherits(qzkrE, _Component);

  function qzkrE() {
    _classCallCheck(this, qzkrE);

    return _possibleConstructorReturn(this, (qzkrE.__proto__ || Object.getPrototypeOf(qzkrE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qzkrE, _step_7Soy2.default);

exports.default = qzkrE;
...
exports.templates = exports.qzkrE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qzkrE.
   * @public
   */

  goog.module('qzkrE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qzkrE.render';
  }
...
_metalSoy2.default.register(qzkrE, templates);
exports.qzkrE = qzkrE;
