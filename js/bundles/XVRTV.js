...
var _schemaSoy = __webpack_require__(327);
...
var XVRTV = function (_Component) {
  _inherits(XVRTV, _Component);

  function XVRTV() {
    _classCallCheck(this, XVRTV);

    return _possibleConstructorReturn(this, (XVRTV.__proto__ || Object.getPrototypeOf(XVRTV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(XVRTV, _schemaSoy2.default);

exports.default = XVRTV;
...
exports.templates = exports.XVRTV = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace XVRTV.
   * @public
   */

  goog.module('XVRTV.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'XVRTV.render';
  }
...
_metalSoy2.default.register(XVRTV, templates);
exports.XVRTV = XVRTV;
