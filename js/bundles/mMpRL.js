...
var mMpRL = function (_Component) {
  _inherits(mMpRL, _Component);

  function mMpRL() {
    _classCallCheck(this, mMpRL);

    return _possibleConstructorReturn(this, (mMpRL.__proto__ || Object.getPrototypeOf(mMpRL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mMpRL, _step_2Soy2.default);

exports.default = mMpRL;
...
exports.templates = exports.mMpRL = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace mMpRL.
   * @public
   */

  goog.module('mMpRL.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'mMpRL.render';
  }
...
_metalSoy2.default.register(mMpRL, templates);
exports.mMpRL = mMpRL;
