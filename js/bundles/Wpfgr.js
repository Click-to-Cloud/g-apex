...
var Wpfgr = function (_Component) {
  _inherits(Wpfgr, _Component);

  function Wpfgr() {
    _classCallCheck(this, Wpfgr);

    return _possibleConstructorReturn(this, (Wpfgr.__proto__ || Object.getPrototypeOf(Wpfgr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Wpfgr, _step_15Soy2.default);

exports.default = Wpfgr;
...
exports.templates = exports.Wpfgr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Wpfgr.
   * @public
   */

  goog.module('Wpfgr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Wpfgr.render';
  }
...
_metalSoy2.default.register(Wpfgr, templates);
exports.Wpfgr = Wpfgr;
