...
var Nrxaf = function (_Component) {
  _inherits(Nrxaf, _Component);

  function Nrxaf() {
    _classCallCheck(this, Nrxaf);

    return _possibleConstructorReturn(this, (Nrxaf.__proto__ || Object.getPrototypeOf(Nrxaf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Nrxaf, _step_2Soy2.default);

exports.default = Nrxaf;
...
exports.templates = exports.Nrxaf = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Nrxaf.
   * @public
   */

  goog.module('Nrxaf.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Nrxaf.render';
  }
...
_metalSoy2.default.register(Nrxaf, templates);
exports.Nrxaf = Nrxaf;
