...
var kdicC = function (_Component) {
  _inherits(kdicC, _Component);

  function kdicC() {
    _classCallCheck(this, kdicC);

    return _possibleConstructorReturn(this, (kdicC.__proto__ || Object.getPrototypeOf(kdicC)).apply(this, arguments));
  }
...
_metalSoy2.default.register(kdicC, _step_4Soy2.default);

exports.default = kdicC;
...
exports.templates = exports.kdicC = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace kdicC.
   * @public
   */

  goog.module('kdicC.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'kdicC.render';
  }
...
_metalSoy2.default.register(kdicC, templates);
exports.kdicC = kdicC;
