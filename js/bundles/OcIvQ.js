...
var OcIvQ = function (_Component) {
  _inherits(OcIvQ, _Component);

  function OcIvQ() {
    _classCallCheck(this, OcIvQ);

    return _possibleConstructorReturn(this, (OcIvQ.__proto__ || Object.getPrototypeOf(OcIvQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OcIvQ, _data_typeSoy2.default);

exports.default = OcIvQ;
...
exports.templates = exports.OcIvQ = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace OcIvQ.
   * @public
   */

  goog.module('OcIvQ.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'OcIvQ.render';
  }
...
_metalSoy2.default.register(OcIvQ, templates);
exports.OcIvQ = OcIvQ;
