...
var vJpMT = function (_Component) {
  _inherits(vJpMT, _Component);

  function vJpMT() {
    _classCallCheck(this, vJpMT);

    return _possibleConstructorReturn(this, (vJpMT.__proto__ || Object.getPrototypeOf(vJpMT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vJpMT, _schemaSoy2.default);

exports.default = vJpMT;
...
exports.templates = exports.vJpMT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vJpMT.
   * @public
   */

  goog.module('vJpMT.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vJpMT.render';
  }
...
_metalSoy2.default.register(vJpMT, templates);
exports.vJpMT = vJpMT;
