...
var iMvRk = function (_Component) {
  _inherits(iMvRk, _Component);

  function iMvRk() {
    _classCallCheck(this, iMvRk);

    return _possibleConstructorReturn(this, (iMvRk.__proto__ || Object.getPrototypeOf(iMvRk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iMvRk, _indexSoy2.default);

exports.default = iMvRk;
...
exports.templates = exports.iMvRk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iMvRk.
   * @public
   */

  goog.module('iMvRk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iMvRk.render';
  }
...
_metalSoy2.default.register(iMvRk, templates);
exports.iMvRk = iMvRk;
