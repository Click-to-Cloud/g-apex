...
var YtNRF = function (_Component) {
  _inherits(YtNRF, _Component);

  function YtNRF() {
    _classCallCheck(this, YtNRF);

    return _possibleConstructorReturn(this, (YtNRF.__proto__ || Object.getPrototypeOf(YtNRF)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YtNRF, _directiveSoy2.default);

exports.default = YtNRF;
...
exports.templates = exports.YtNRF = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YtNRF.
   * @public
   */

  goog.module('YtNRF.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YtNRF.render';
  }
...
_metalSoy2.default.register(YtNRF, templates);
exports.YtNRF = YtNRF;
