...
var _step_14Soy = __webpack_require__(309);
...
var MgKdE = function (_Component) {
  _inherits(MgKdE, _Component);

  function MgKdE() {
    _classCallCheck(this, MgKdE);

    return _possibleConstructorReturn(this, (MgKdE.__proto__ || Object.getPrototypeOf(MgKdE)).apply(this, arguments));
  }
...
_metalSoy2.default.register(MgKdE, _step_14Soy2.default);

exports.default = MgKdE;
...
exports.templates = exports.MgKdE = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace MgKdE.
   * @public
   */

  goog.module('MgKdE.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'MgKdE.render';
  }
...
_metalSoy2.default.register(MgKdE, templates);
exports.MgKdE = MgKdE;
