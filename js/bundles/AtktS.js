...
var AtktS = function (_Component) {
  _inherits(AtktS, _Component);

  function AtktS() {
    _classCallCheck(this, AtktS);

    return _possibleConstructorReturn(this, (AtktS.__proto__ || Object.getPrototypeOf(AtktS)).apply(this, arguments));
  }
...
_metalSoy2.default.register(AtktS, _parametersSoy2.default);

exports.default = AtktS;
...
exports.templates = exports.AtktS = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace AtktS.
   * @public
   */

  goog.module('AtktS.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'AtktS.render';
  }
...
_metalSoy2.default.register(AtktS, templates);
exports.AtktS = AtktS;
