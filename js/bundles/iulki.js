...
var iulki = function (_Component) {
  _inherits(iulki, _Component);

  function iulki() {
    _classCallCheck(this, iulki);

    return _possibleConstructorReturn(this, (iulki.__proto__ || Object.getPrototypeOf(iulki)).apply(this, arguments));
  }
...
_metalSoy2.default.register(iulki, _resolverSoy2.default);

exports.default = iulki;
...
exports.templates = exports.iulki = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace iulki.
   * @public
   */

  goog.module('iulki.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'iulki.render';
  }
...
_metalSoy2.default.register(iulki, templates);
exports.iulki = iulki;
