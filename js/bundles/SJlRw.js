...
var SJlRw = function (_Component) {
  _inherits(SJlRw, _Component);

  function SJlRw() {
    _classCallCheck(this, SJlRw);

    return _possibleConstructorReturn(this, (SJlRw.__proto__ || Object.getPrototypeOf(SJlRw)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SJlRw, _step_2Soy2.default);

exports.default = SJlRw;
...
exports.templates = exports.SJlRw = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace SJlRw.
   * @public
   */

  goog.module('SJlRw.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'SJlRw.render';
  }
...
_metalSoy2.default.register(SJlRw, templates);
exports.SJlRw = SJlRw;
