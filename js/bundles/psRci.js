...
var psRci = function (_Component) {
  _inherits(psRci, _Component);

  function psRci() {
    _classCallCheck(this, psRci);

    return _possibleConstructorReturn(this, (psRci.__proto__ || Object.getPrototypeOf(psRci)).apply(this, arguments));
  }
...
_metalSoy2.default.register(psRci, _step_4Soy2.default);

exports.default = psRci;
...
exports.templates = exports.psRci = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace psRci.
   * @public
   */

  goog.module('psRci.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'psRci.render';
  }
...
_metalSoy2.default.register(psRci, templates);
exports.psRci = psRci;
