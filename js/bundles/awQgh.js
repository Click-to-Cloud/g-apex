...
var awQgh = function (_Component) {
  _inherits(awQgh, _Component);

  function awQgh() {
    _classCallCheck(this, awQgh);

    return _possibleConstructorReturn(this, (awQgh.__proto__ || Object.getPrototypeOf(awQgh)).apply(this, arguments));
  }
...
_metalSoy2.default.register(awQgh, _step_15Soy2.default);

exports.default = awQgh;
...
exports.templates = exports.awQgh = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace awQgh.
   * @public
   */

  goog.module('awQgh.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'awQgh.render';
  }
...
_metalSoy2.default.register(awQgh, templates);
exports.awQgh = awQgh;
