...
var RBWpO = function (_Component) {
  _inherits(RBWpO, _Component);

  function RBWpO() {
    _classCallCheck(this, RBWpO);

    return _possibleConstructorReturn(this, (RBWpO.__proto__ || Object.getPrototypeOf(RBWpO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(RBWpO, _step_1Soy2.default);

exports.default = RBWpO;
...
exports.templates = exports.RBWpO = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace RBWpO.
   * @public
   */

  goog.module('RBWpO.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'RBWpO.render';
  }
...
_metalSoy2.default.register(RBWpO, templates);
exports.RBWpO = RBWpO;
