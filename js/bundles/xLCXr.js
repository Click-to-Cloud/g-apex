...
var xLCXr = function (_Component) {
  _inherits(xLCXr, _Component);

  function xLCXr() {
    _classCallCheck(this, xLCXr);

    return _possibleConstructorReturn(this, (xLCXr.__proto__ || Object.getPrototypeOf(xLCXr)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xLCXr, _step_3Soy2.default);

exports.default = xLCXr;
...
exports.templates = exports.xLCXr = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xLCXr.
   * @public
   */

  goog.module('xLCXr.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xLCXr.render';
  }
...
_metalSoy2.default.register(xLCXr, templates);
exports.xLCXr = xLCXr;
