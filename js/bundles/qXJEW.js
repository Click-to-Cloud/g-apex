...
var qXJEW = function (_Component) {
  _inherits(qXJEW, _Component);

  function qXJEW() {
    _classCallCheck(this, qXJEW);

    return _possibleConstructorReturn(this, (qXJEW.__proto__ || Object.getPrototypeOf(qXJEW)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qXJEW, _data_typeSoy2.default);

exports.default = qXJEW;
...
exports.templates = exports.qXJEW = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace qXJEW.
   * @public
   */

  goog.module('qXJEW.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'qXJEW.render';
  }
...
_metalSoy2.default.register(qXJEW, templates);
exports.qXJEW = qXJEW;
