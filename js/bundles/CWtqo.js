...
var _step_2Soy = __webpack_require__(313);
...
var CWtqo = function (_Component) {
  _inherits(CWtqo, _Component);

  function CWtqo() {
    _classCallCheck(this, CWtqo);

    return _possibleConstructorReturn(this, (CWtqo.__proto__ || Object.getPrototypeOf(CWtqo)).apply(this, arguments));
  }
...
_metalSoy2.default.register(CWtqo, _step_2Soy2.default);

exports.default = CWtqo;
...
exports.templates = exports.CWtqo = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace CWtqo.
   * @public
   */

  goog.module('CWtqo.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param726 = function param726() {
      ...
      ie_close('p');
      ie_open('p');
      itext('G.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'CWtqo.render';
  }
...
_metalSoy2.default.register(CWtqo, templates);
exports.CWtqo = CWtqo;
