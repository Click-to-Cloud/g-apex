...
var ninai = function (_Component) {
  _inherits(ninai, _Component);

  function ninai() {
    _classCallCheck(this, ninai);

    return _possibleConstructorReturn(this, (ninai.__proto__ || Object.getPrototypeOf(ninai)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ninai, _step_5Soy2.default);

exports.default = ninai;
...
exports.templates = exports.ninai = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace ninai.
   * @public
   */

  goog.module('ninai.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'ninai.render';
  }
...
_metalSoy2.default.register(ninai, templates);
exports.ninai = ninai;
