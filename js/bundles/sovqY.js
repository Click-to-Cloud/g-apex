...
var sovqY = function (_Component) {
  _inherits(sovqY, _Component);

  function sovqY() {
    _classCallCheck(this, sovqY);

    return _possibleConstructorReturn(this, (sovqY.__proto__ || Object.getPrototypeOf(sovqY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sovqY, _step_5Soy2.default);

exports.default = sovqY;
...
exports.templates = exports.sovqY = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace sovqY.
   * @public
   */

  goog.module('sovqY.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'sovqY.render';
  }
...
_metalSoy2.default.register(sovqY, templates);
exports.sovqY = sovqY;
